# art-in-island — photos

Drop photos in this folder, then reference them from
`src/content/travels/art-in-island.md` using site-root paths:

- `cover.jpg`          → `/static/travels/art-in-island/cover.jpg`
- `01.jpg`, `02.jpg`…  → `/static/travels/art-in-island/01.jpg`
