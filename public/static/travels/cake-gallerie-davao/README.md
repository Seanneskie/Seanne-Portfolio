# Cake Gallerie — Davao — photos

Drop photos in this folder, then reference them from
`src/content/travels/cake-gallerie-davao.md` using site-root paths:

- `cover.jpg`          → `/static/travels/cake-gallerie-davao/cover.jpg`
- `01.jpg`, `02.jpg`…  → `/static/travels/cake-gallerie-davao/01.jpg`
