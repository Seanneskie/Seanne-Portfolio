# Altitude at SM Lanang — photos

Drop photos in this folder, then reference them from
`src/content/travels/altitude-sm-lanang.md` using site-root paths:

- `cover.jpg`          → `/static/travels/altitude-sm-lanang/cover.jpg`
- `01.jpg`, `02.jpg`…  → `/static/travels/altitude-sm-lanang/01.jpg`
