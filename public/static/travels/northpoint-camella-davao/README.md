# NorthPoint by Camella — photos

Drop photos in this folder, then reference them from
`src/content/travels/northpoint-camella-davao.md` using site-root paths:

- `cover.jpg`          → `/static/travels/northpoint-camella-davao/cover.jpg`
- `01.jpg`, `02.jpg`…  → `/static/travels/northpoint-camella-davao/01.jpg`
