# Cavenico il Mare — Samal — photos

Drop photos in this folder, then reference them from
`src/content/travels/cavenico-il-mare-samal.md` using site-root paths:

- `cover.jpg`          → `/static/travels/cavenico-il-mare-samal/cover.jpg`
- `01.jpg`, `02.jpg`…  → `/static/travels/cavenico-il-mare-samal/01.jpg`
