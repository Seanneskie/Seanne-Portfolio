# Cavenico il Mare — Water Activities — photos

Drop photos in this folder, then reference them from
`src/content/travels/cavenico-il-mare-activities.md` using site-root paths:

- `cover.jpg`          → `/static/travels/cavenico-il-mare-activities/cover.jpg`
- `01.jpg`, `02.jpg`…  → `/static/travels/cavenico-il-mare-activities/01.jpg`
