# uaap-dlsu-vs-feu — photos

Drop photos in this folder, then reference them from
`src/content/travels/uaap-dlsu-vs-feu.md` using site-root paths:

- `cover.jpg`          → `/static/travels/uaap-dlsu-vs-feu/cover.jpg`
- `01.jpg`, `02.jpg`…  → `/static/travels/uaap-dlsu-vs-feu/01.jpg`
