# riverwalk-cafe-mandaluyong — photos

Drop photos in this folder, then reference them from
`src/content/travels/riverwalk-cafe-mandaluyong.md` using site-root paths:

- `cover.jpg`          → `/static/travels/riverwalk-cafe-mandaluyong/cover.jpg`
- `01.jpg`, `02.jpg`…  → `/static/travels/riverwalk-cafe-mandaluyong/01.jpg`
