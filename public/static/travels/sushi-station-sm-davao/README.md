# Sushi Station — SM City Davao — photos

Drop photos in this folder, then reference them from
`src/content/travels/sushi-station-sm-davao.md` using site-root paths:

- `cover.jpg`          → `/static/travels/sushi-station-sm-davao/cover.jpg`
- `01.jpg`, `02.jpg`…  → `/static/travels/sushi-station-sm-davao/01.jpg`
